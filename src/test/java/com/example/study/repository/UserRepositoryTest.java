...
public class UserRepositoryTest extends StudyApplicationTests {
    ...
    public void create() {
        ...
        User u = User.builder()                  //lombok annotation builder를 이용한 값 생성
                .account(account)
                .password(password)
                .status(status)
                .email(email)
    ...
    public void read() {
        ...
        //user.setEmail().setStatus().setPhoneNumber();    lombok annotation accessor를 이용한 값 수정
    ...
    @Test
    @Transactional // 실제로 데이터 베이스에서 지우진 않는 어노테이션
    public void delete() {
